...
const SUCHANG = () => {
  return (
    <>
      <Column gap={48}>
        <Image url="https://assets.visionarylabstech.com/post/portfolio/suchang/1.jpg" ratio="16 / 9" />
        <Row>
          <Mix>
          ...
          <Row gap={12}>
            ...
            <Image url="https://assets.visionarylabstech.com/post/portfolio/suchang/3.jpg" />
          </Row>
        </Row>
      </Column>
      <Row>
